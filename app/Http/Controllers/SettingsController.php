...
class SettingsController extends Controller
{
    ...
    {
        R::exec('DELETE FROM merchants WHERE id = ?', [$post->id]);
        R::exec('DELETE FROM merchant_cards WHERE merchant_id = ?', [$post->id]);
    ...
    {
        R::exec('DELETE FROM merchant_cards WHERE id = ?', [$post->id]);
