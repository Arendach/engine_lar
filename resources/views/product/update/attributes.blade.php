<form class="form-horizontal" data-type="ajax" action="@uri('product/update_attributes')">
            ...
            <div class="col-md-offset-2 col-md-8">
                <div class="panel-group" id="attribute_list" style="margin-bottom: 0;">
                    @if($product->attributes->count() > 0)
                        <?php $c = 0; ?>
                        @foreach ($product->attributes as $name => $item)
                            <div class="panel panel-default attribute_item">
                                <div class="panel-heading">
                                    <h4 class="panel-title relative">
                                        <a data-toggle="collapse" data-parent="#attribute_list" href="#collapse<?= $c ?>">
                                            {{ $name }}
                                        </a>
